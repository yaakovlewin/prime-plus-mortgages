const servicesData = [
    {
        ...
        details: [
            ...
            },
            {
                ...
                description: "With Prime Plus Mortgages, you're not just getting a loan; you're gaining a team of seasoned mortgage professionals dedicated to your homebuying success. We collaborate with a diverse range of lenders to secure the most advantageous rates and terms, all while providing expert advice tailored to the unique needs of first-time buyers. Let us guide you through each phase of the process, making your journey to homeownership straightforward and successful.",
                icon: "FaUserTie"
            },
            {
        ...
        details: [
            {
                ...
                description: "Dive into the world of buy-to-let investments with Prime Plus Mortgages, where securing the most favorable rates and terms is just the beginning. Our seasoned experts simplify the journey, from exploring options to clinching your ideal purchase or refinancing deal. Tailored for investors eyeing new acquisitions or optimizing current assets, our comprehensive suite ensures your venture is as lucrative as it is effortless.",
                icon: "FaChartLine"
            },
            {
        ...
        details: [
            {
                ...
                description: "Unlock the potential of short-term financing with Prime Plus Mortgages, where optimal rates and favorable terms meet swift, seamless execution. Our adept team demystifies the mortgage process, whether you're eyeing a quick purchase or aiming to refinance. Equipped with extensive knowledge and resources, we're here to ensure your short-term financing aligns perfectly with your immediate objectives.",
                icon: "FaChartLine"
            },
            {
        ...
        details: [
            {
                ...
                description: "Prime Plus Mortgages specializes in commercial mortgages, offering optimal rates and terms to propel your business forward. Our experienced team provides comprehensive guidance, ensuring a seamless process from initial inquiry to final closing. Whether acquiring a new property or refinancing to leverage current assets, our expertise supports your commercial ambitions.",
                icon: "FaChartLine"
            },
            {
                title: "Customized Financial Strategies",
