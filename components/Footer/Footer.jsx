...
export default function Footer() {
    return (
        <footer className="bg-gray-800 text-gray-300 px-6 lg:px-12 py-12">
            <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <FooterLink href="/remortgages">ReMortgages</FooterLink>
                        <FooterLink href="/insurance">Insurance</FooterLink>
                        <FooterLink href="/bridging">Bridging</FooterLink>
                        <FooterLink href="/buy-to-let">Buy To Let</FooterLink>
            ...
            <div className="text-center mt-8">
                <p>
                    &copy; {new Date().getFullYear()} Prime Plus Mortgages. All
                    rights reserved.
                </p>
            </div>
            {/* designed by */}
