...
export default function ServiceHeroSection({ service }) {
  return (
    <div className="bg-sky-100 heropattern-tinycheckers-sky-300/50">
      <section
        className="mx-auto flex min-h-[40vh] max-w-[2000px] items-center border-x-4 border-green-200 bg-cyan-50 bg-opacity-70 bg-cover bg-center object-fill px-10 py-24 text-teal-50 text-shadow-black-border-sm sm:h-[50vh] md:h-[60vh] lg:h-[70vh] "
