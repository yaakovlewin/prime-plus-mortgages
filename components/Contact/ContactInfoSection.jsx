      ...
      <div className="container mx-auto px-4 text-center">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <ContactCard title="Phone">
            ...
            <button className="focus:shadow-outline-cyan mt-2 inline-flex items-center justify-center rounded-md border border-transparent bg-cyan-600 px-5 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out hover:bg-cyan-500 focus:border-cyan-700 focus:outline-none active:bg-cyan-700">
